...
if (!isset($_SESSION['username'])) {
  ...
  echo '<div class="text-center text-light d-inline-block p-2 mt-4 mb-3 bg-danger" style="border: 1px; margin-left:650px;">Silahkan LOGIN terlebih dahulu untuk dapat memesan menu</div>';
} else {
